...
namespace BlockchainDemo
{
    class Program
    {
        ...
        public static string nameOtherSide;
            ...
            while (selection != 4)
            {
                switch (selection)
                {
                    case 1:
                        ...
                        Console.WriteLine($"Balance of {name}: "+PhillyCoin.GetBalance(name));
                        Console.WriteLine($"Balance of {nameOtherSide}: " + PhillyCoin.GetBalance(nameOtherSide));
                        break;
                    case 2:
                        ...
                        if (int.Parse(amount) > PhillyCoin.GetBalance(name))
                        {
